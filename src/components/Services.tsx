...
export function Services() {
  return (
    <section id="solutions" className="relative overflow-hidden bg-transparent py-24 md:py-32">
        ...
        >
          {HOMEPAGE_SERVICES.map((service) => (
            <motion.li
              ...
              className="group flex flex-col rounded-[1.75rem] bg-white/50 p-7 shadow-[0_28px_70px_-44px_rgb(0_0_0/0.12)] ring-1 ring-white/70 backdrop-blur-md transition hover:bg-white/60 hover:shadow-[0_36px_80px_-42px_rgb(0_0_0/0.16)]"
            >
              ...
              <ul className="mt-5 space-y-2 pt-2 text-sm text-stone-600">
              ...
              <div className="mt-6 flex flex-wrap items-center justify-between gap-3 pt-4 text-xs text-stone-500">
