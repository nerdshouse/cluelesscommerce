...
export const SERVICE_PAGES: ServicePageData[] = [
  {
    ...
    keyFeatures: [
      ...
      { title: 'Launch playbooks', body: 'Repeatable checklists for drops, sales, and season resets so the feed never goes quiet without a plan.' },
    ],
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      { title: 'Finance-friendly reporting', body: 'Board-ready views on spend, efficiency, and learnings without spreadsheet archaeology.' },
    ],
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      { title: 'Handoff without gaps', body: 'Specs, tokens, and QA notes your team can extend — not a black-box PDF.' },
    ],
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      { title: 'Human in the loop', body: 'Review gates and escalation paths before anything customer-facing goes live.' },
    ],
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      { title: 'Stakeholder alignment', body: 'One-page decisions and follow-ups so product, growth, and leadership stay on the same page.' },
    ],
